...
struct ccc
{
    ConcurrentQueue<char*> fullBuffers;
    ConcurrentQueue<char*> emptyBuffers;

    void pushEmpty(char* buffer) { emptyBuffers.push(buffer); }
    void wpopEmpty(char* buffer) { emptyBuffers.wpop(buffer); }

    void pushFull(char* buffer) { fullBuffers.push(buffer); }
    void wpopFull(char* buffer) { fullBuffers.wpop(buffer); }
};
